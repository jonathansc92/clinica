...
$(document).ready(function(){
    ...
    $("#filer_input1").filer({
                            ...
                            <div class="jFiler-item-container">\
                                <div class="jFiler-item-inner">\
                                    <div class="jFiler-item-thumb">\
                                        <div class="jFiler-item-status"></div>\
                                        <div class="jFiler-item-info">\
                                            <span class="jFiler-item-title"><b title="{{fi-name}}">{{fi-name | limitTo: 25}}sss</b></span>\
                                            <span class="jFiler-item-others">{{fi-size2}}</span>\
                                        </div>\
                                        {{fi-image}}\
                                    </div>\
        ...
        uploadFile: {
            ...
            url: "http://127.0.0.1:8080/travel_three/public/theme/uplon-admin/assets/plugins/jquery.filer/php/upload.php",
            data: null,
            type: 'POST',
