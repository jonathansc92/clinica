...
<head>
    ...
    <title>Admin - Viagem a três</title>
    ...
    <div id="app" style='display:none'>
        @if (!Auth::guest())
            ...
            <menudefault>
                ...
                {{--<li class="has_sub">--}}
                {{--<a href="/admin/categorias" class="waves-effect"><i--}}
                {{--class="fa fa-cogs"></i><span> Categorias </span> </a>--}}
                {{--</li>--}}


                <li class="has_sub">
                    <a href="/admin/posts" class="waves-effect"><i class="fa fa-newspaper-o"></i><span> Posts </span>
                    </a>
                </li>

                <li class="has_sub">
                    <a href="/admin/dicas" class="waves-effect"><i class="fa fa-newspaper-o"></i><span> Dicas </span>
                    </a>
                </li>

                <li class="has_sub">
                    <a href="/admin/comentarios" class="waves-effect"><i
                                class="fa fa-envelope"></i><span> Mensagens </span>
                    </a>
                </li>


                <!--                    <li  class="has_sub">
                                        <a href="#" class="waves-effect"><i class="fa fa-image"></i><span> Galeria </span> </a>
                                    </li>-->
